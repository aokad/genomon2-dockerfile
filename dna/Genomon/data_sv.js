...
ca_data.links = [["tumor","10",2644790,"10",2680137,true,1,[['+','-','KCNQ1OT1;KCNQ1','KCNQ1OT1;KCNQ1','deletion',],]],["tumor","10",12553283,"21",25051359,false,0,[['+','-','PARVA','POM121L10P','translocation',],]],["tumor","21",27068016,"21",27070655,true,1,[['-','-','MIAT','MIAT;MIATNB','inversion',],]],["tumor","21",27068015,"21",27070654,true,1,[['+','+','MIAT','MIAT;MIATNB','inversion',],]],["tumor","21",40725723,"21",40728297,true,1,[['+','-','TNRC6B','TNRC6B','deletion',],]],["tumor","21",44640224,"21",44642022,true,1,[['-','+','KIAA1644','KIAA1644','tandem_duplication',],]],];
ca_data.select_value = [[1,1],[2,2,1],];
ca_data.select_key = [[[21,5],[10,2]],[[21,8],[21,5],[10,0]],];
ca_data.select_item = [[[0],[0]],[[0],[0],[0]],];
