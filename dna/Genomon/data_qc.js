...
qc_data.Ids = ['normal','tumor',];
qc_data.plots = [{chart_id:'chart_brush', title:'', title_y:'', stack:{format:[[{label:'{average_depth}',type:'str',keys:['average_depth',],ext:''},],], keys: '{average_depth} '}, stack_id:['stack0',], label:['average',], color:['#E3E5E9',], tooltip:{format:[], keys: ''}},{chart_id:'chart_1', title:'Depth coverage', title_y:'Coverage', stack:{format:[[{label:'{ratio_30x}',type:'str',keys:['ratio_30x',],ext:''},],[{label:'{ratio_20x}-{ratio_30x}',type:'numeric',keys:['ratio_20x','ratio_30x',],ext:''},],[{label:'{ratio_10x}-{ratio_20x}',type:'numeric',keys:['ratio_10x','ratio_20x',],ext:''},],[{label:'{ratio_2x}-{ratio_10x}',type:'numeric',keys:['ratio_2x','ratio_10x',],ext:''},],], keys: '{ratio_10x} {ratio_20x} {ratio_2x} {ratio_30x} '}, stack_id:['stack0','stack1','stack2','stack3',], label:['Ratio 30x','Ratio 20x','Ratio 10x','Ratio  2x',], color:['#2478B4','#FF7F0E','#2CA02C','#D62728',], tooltip:{format:[[{label:'Sample:',type:'fix',keys:[],ext:''},{label:'{id}',type:'str',keys:['id',],ext:''},],[{label:'Ratio  2x: ',type:'fix',keys:[],ext:''},{label:'{ratio_2x}',type:'numeric',keys:['ratio_2x',],ext:'.2'},],[{label:'Ratio 10x: ',type:'fix',keys:[],ext:''},{label:'{ratio_10x}',type:'numeric',keys:['ratio_10x',],ext:'.2'},],[{label:'Ratio 20x: ',type:'fix',keys:[],ext:''},{label:'{ratio_20x}',type:'numeric',keys:['ratio_20x',],ext:'.2'},],[{label:'Ratio 30x: ',type:'fix',keys:[],ext:''},{label:'{ratio_30x}',type:'numeric',keys:['ratio_30x',],ext:'.2'},],], keys: '{id} {ratio_10x} {ratio_20x} {ratio_2x} {ratio_30x} '}},{chart_id:'chart_2', title:'Average depth', title_y:'Average of depth', stack:{format:[[{label:'{average_depth}',type:'str',keys:['average_depth',],ext:''},],], keys: '{average_depth} '}, stack_id:['stack0',], label:['Average depth',], color:['#2478B4',], tooltip:{format:[[{label:'Sample:',type:'fix',keys:[],ext:''},{label:'{id}',type:'str',keys:['id',],ext:''},],[{label:'{average_depth}',type:'numeric',keys:['average_depth',],ext:'.2'},],], keys: '{average_depth} {id} '}},{chart_id:'chart_3', title:'Mapped_reads/total_reads', title_y:'Rate', stack:{format:[[{label:'{mapped_reads}/{total_reads}',type:'numeric',keys:['mapped_reads','total_reads',],ext:''},],], keys: '{mapped_reads} {total_reads} '}, stack_id:['stack0',], label:['mapped_reads/total_reads',], color:['#2478B4',], tooltip:{format:[[{label:'Sample ID:',type:'fix',keys:[],ext:''},{label:'{id}',type:'str',keys:['id',],ext:''},],[{label:'{mapped_reads}/{total_reads}',type:'numeric',keys:['mapped_reads','total_reads',],ext:'.2'},],], keys: '{id} {mapped_reads} {total_reads} '}},{chart_id:'chart_4', title:'Mean_insert_size', title_y:'Mean_insert_size', stack:{format:[[{label:'{mean_insert_size}',type:'str',keys:['mean_insert_size',],ext:''},],], keys: '{mean_insert_size} '}, stack_id:['stack0',], label:['mean_insert_size',], color:['#2478B4',], tooltip:{format:[[{label:'Sample ID:',type:'fix',keys:[],ext:''},{label:'{id}',type:'str',keys:['id',],ext:''},],[{label:'{mean_insert_size}',type:'numeric',keys:['mean_insert_size',],ext:'.2'},],], keys: '{id} {mean_insert_size} '}},{chart_id:'chart_5', title:'Duplicate_reads/total_reads', title_y:'Rate', stack:{format:[[{label:'{duplicate_reads}/{total_reads}',type:'numeric',keys:['duplicate_reads','total_reads',],ext:''},],], keys: '{duplicate_reads} {total_reads} '}, stack_id:['stack0',], label:['duplicate_reads/total_reads',], color:['#2478B4',], tooltip:{format:[[{label:'Sample ID:',type:'fix',keys:[],ext:''},{label:'{id}',type:'str',keys:['id',],ext:''},],[{label:'{duplicate_reads}/{total_reads}',type:'numeric',keys:['duplicate_reads','total_reads',],ext:'.2'},],], keys: '{duplicate_reads} {id} {total_reads} '}},{chart_id:'chart_6', title:'Read_length_r1, read_length_r2', title_y:'Read_length', stack:{format:[[{label:'{read_length_r1}',type:'str',keys:['read_length_r1',],ext:''},],[{label:'{read_length_r2}',type:'str',keys:['read_length_r2',],ext:''},],], keys: '{read_length_r1} {read_length_r2} '}, stack_id:['stack0','stack1',], label:['read_length_r1','read_length_r2',], color:['#2478B4','#FF7F0E',], tooltip:{format:[[{label:'Sample ID:',type:'fix',keys:[],ext:''},{label:'{id}',type:'str',keys:['id',],ext:''},],[{label:'r1: ',type:'fix',keys:[],ext:''},{label:'{read_length_r1}',type:'numeric',keys:['read_length_r1',],ext:','},],[{label:'r2: ',type:'fix',keys:[],ext:''},{label:'{read_length_r2}',type:'numeric',keys:['read_length_r2',],ext:','},],], keys: '{id} {read_length_r1} {read_length_r2} '}},];
...
qc_data.value = [[0.03,356,'tumor',112438,250.52,0.00,0.00,0.00,0.00,100,100,112438],[0.03,410,'normal',114690,249.89,0.00,0.00,0.00,0.00,100,100,114690],];function tooltip_partial(format, data) {
